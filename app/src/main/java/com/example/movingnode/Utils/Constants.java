package com.example.movingnode.Utils;

public class Constants {
/*    public static String ClientId = "2018mmmut2022";
    public static String Topic = "project2022";
    ...
    public static String WebsocketUrl = "ws://192.168.162.82:3000/";
